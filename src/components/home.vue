        ...
        <el-aside width="200px">
          ...
          <el-menu :default-active="$route.path" style="min-height: 100%;" router>
            ...
            <el-submenu index="2">
              ...
              <el-menu-item-group>
                <el-menu-item index="/home/deptList">权限管理</el-menu-item>
              </el-menu-item-group>
            </el-submenu>
            ...
            <el-submenu index="3">
              ...
              <el-menu-item-group>
                <el-menu-item index="/home/materialNum">物资订单申请</el-menu-item>
              </el-menu-item-group>

              <el-menu-item-group>
                <el-menu-item index="/home/materialInfo">物资订单审批</el-menu-item>
              </el-menu-item-group>
            ...
            <el-submenu index="4">
              ...
              <el-menu-item-group>
                <el-menu-item index="/home/needPlan">食品分类</el-menu-item>
              </el-menu-item-group>
