<template>
  <div>
    <div class="topButton">
      <el-button size="mini" type="primary" @click="openAdd()">申请订单号</el-button>

      <el-button size="mini" type="warning" @click="openGet()">修改订单信息</el-button>
    ...
    <div class="list">
      ...
      >
        <el-table-column label="订单编号" prop="materialNum"></el-table-column>
