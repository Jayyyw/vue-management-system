<template>
  <div>
    <div class="topButton">
      <el-button size="mini" type="primary" @click="shenpigo()">物资订单通过</el-button>
      <el-button size="mini" type="danger" @click="bohui()">订单驳回</el-button>
    </div>
    <div class="list">
      <el-table
      ...
      >
        <el-table-column label="订单编码" prop="materialNum"></el-table-column>

        <el-table-column label="订单名称" prop="materialName"></el-table-column>

        <el-table-column label="订单申请时间" prop="materialPostTime"></el-table-column>

        <el-table-column label="物资订单通过时间" prop="materialPassTime"></el-table-column>
